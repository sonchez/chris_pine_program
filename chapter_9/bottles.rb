...
bottles = 200
lessbottles = english_number(bottles-1)

while bottles > 0
  numberbottles = english_number(bottles)
  puts
  puts numberbottles + ' bottles of beer on the wall'
  puts numberbottles + ' bottles of beer!'
  puts 'take one down, pass it around'
  puts lessbottles + ' bottles of beer on the wall'
  puts
  bottles = bottles -1
  lessbottles = english_number(bottles-1)
end